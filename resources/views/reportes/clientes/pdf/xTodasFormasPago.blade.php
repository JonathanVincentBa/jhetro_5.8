...
<body>
    <center><h1><b>Reportes de cliente con todas las formas de pago</b></h1></center>    
    <div class="datagrid">
        <table>
            <thead>
                <tr>
            ...
            <tbody>
                @foreach ($guias as $guia)
                {
                    <tr>
                        ...
                        @if($guia->estatus_cobro=='Pendiente')
                            <td>Por Pagar</td>
                        @else
                            <td>Pagado</td>
                        @endif
            ...
            <tfoot>
                <tr>
                    <td colspan="8" style="text-align: left;">Total Guias</td>
                    @foreach ( $suma as $reg )
