...
@section ('contenido')
        <div class="row">
            ...
            <div class="col-lg-2 col-sm-2 col-md-2 col-xs-12">
                <div class="form-group">
                    <a href="{{URL::action('BuscarGuiaController@index')}}"><button class="btn btn-info">Regresar</button></a>
                </div>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-lg-3 col-sm-3 col-md-3 col-xs-12">
                <div class="form-group">
                    <label>Estatus de guia</label>
                        @if($cabecera->estatus_entrega == 'B')
                            <p>Bodega</p>
                        @elseif($cabecera->estatus_entrega == 'C')
                            <p>En ruta</p>
                        @else
                            <p>Entregado</p>
                        @endif
            ...
            @if($cabecera->estatus_entrega == 'E')
                <div class="col-lg-3 col-sm-3 col-md-3 col-xs-12">
                    <div class="form-group">
                        <label>Nombre del que recibe</label>
                            <p>{{ $cabecera->nombre_recibe }}</p>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-3 col-md-3 col-xs-12">
                    <div class="form-group">
                        <label>D.N.I. del que recibe</label>
                            <p>{{ $cabecera->dni_recibe }}</p>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-3 col-md-3 col-xs-12">
                        <div class="form-group">
                            <label>fecha de entrega</label>
                                <p>{{ $cabecera->fecha_recepcion }}</p>
                        </div>
                    </div>
            @endif
        </div>
